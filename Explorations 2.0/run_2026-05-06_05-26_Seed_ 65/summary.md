# Exploration run · 2026-05-06_05-26
...
| `audio_ib_random` | contributor | -0.032 | genre_top | +0.090 |
| `audio_ib_energy` | contributor | -0.033 | genre_top | +0.090 |
| `audio_mert_orig` | contributor | -0.046 | genre_top | +0.011 |
| `audio_mert_random` | contributor | -0.053 | genre_top | +0.011 |
...
| `audio_ib_random` | -0.052 | -0.097 | +0.039 |
...
| `audio_mert_random` | -0.079 | -0.165 | +0.005 |
...
| `image_clip`  ×  `text_clap_chorus` | 0.02 |
...
| `audio_mert_random` | -0.795 | -0.876 | -0.836 | 1.131 |
...
| `audio_ib_random` | -2.658 | -1.072 | -1.865 | 1.456 |
...
- `audio_ib` baseline R² = -1.033 →  audio_ib_energy: -1.118 (Δ -0.086) · audio_ib_random: -1.865 (Δ -0.833)
- `audio_mert` baseline R² = -0.704 →  audio_mert_energy: -0.780 (Δ -0.076) · audio_mert_random: -0.836 (Δ -0.131)
