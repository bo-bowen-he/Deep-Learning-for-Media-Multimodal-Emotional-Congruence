# Exploration run · 2026-05-06_06-08
...
| `audio_mert_random` | -0.849 | -0.746 | -0.797 | 1.128 |
| `audio_ib_orig` | -1.171 | -0.894 | -1.033 | 1.221 |
| `audio_ib_energy` | -1.574 | -0.663 | -1.118 | 1.251 |
| `audio_ib_random` | -0.869 | -1.487 | -1.178 | 1.233 |
...
- `audio_ib` baseline R² = -1.033 →  audio_ib_energy: -1.118 (Δ -0.086) · audio_ib_random: -1.178 (Δ -0.145)
- `audio_mert` baseline R² = -0.704 →  audio_mert_energy: -0.780 (Δ -0.076) · audio_mert_random: -0.797 (Δ -0.093)
